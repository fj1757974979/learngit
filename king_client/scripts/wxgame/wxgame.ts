        ...
        if (file.extname == '.js') {
            ...
            if (filename == 'libs/modules/egret/egret.js' || filename == 'libs/modules/egret/egret.min.js') {
                ...
                if (filename == 'main.js') {
                    ...
                    content += ";window.WXGame = WXGame;"
                    content = `
                        ;window.gameGlobal = {
                            "serverHost":"www.openew.com",
                            "serverPort":9101,
                            "serverWssPort":9101,
                            "version":"100.100.100",
                            "locale":"cn",
                            ...
                            "channel":"wxgame",
                            "tdChannel":"wxgame",
                            "resPrefix":"king_war_wx",
                            "logoUrl":"loading_logo_yxasg_jpg",
                            "gameName":"英雄爱三国",
                            "isMultiLan":false,
                        };window.support = {
                            "record":false,
                ...
                if (filename == "libs/crypto-js/crypto-js.js" || filename == "libs/crypto-js/crypto-js.min.js") {
