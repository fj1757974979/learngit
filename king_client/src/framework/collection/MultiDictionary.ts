...
module Collection {
    ...
    export class MultiDictionary<K, V> {
        ...
        private equalsF: Collection.IEqualsFunction<V>;
         ...
         */
        constructor(toStrFunction?: (key: K) => string, valuesEqualsFunction?: Collection.IEqualsFunction<V>, allowDuplicateValues = false) {
