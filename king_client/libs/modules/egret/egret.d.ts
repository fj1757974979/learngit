...
declare namespace egret {
    ...
    class BitmapData extends HashObject {
         ...
         * @author elliotlee
         */
        delayLoadCallback: (source: any) => Promise<boolean>;
        private _isDelayLoading;
        /**
...
declare namespace egret.sys {
    ...
    class DisplayList extends HashObject {
        ...
        static createFromPool(target: DisplayObject): DisplayList;
        static returnToPool(displayList: DisplayList): void;
        /**
         * @private
         * 创建一个DisplayList对象
         */
...
declare namespace egret {
    ...
    interface ITextStyle {
         ...
         * 文字绘制回调
         */
        drawCallback?: (textObj: TextField, x: number, y: number, param: any, thisObj: any) => void;
        drawThis?: any;
    }
    /**
...
declare namespace egret {
     ...
     * 根据样式测量文本宽度
     */
    function measureTextWidth(text: any, values: any, style?: ITextStyle): number;
    /**
