...
declare module RES {
    ...
    class ResourceLoader {
         ...
         * 加载队列,存储组的队列
         */
        pushResGroup(list: ResourceInfo[], groupName: string, priority: number, reporter?: PromiseTaskReporter, isTmpLoad?: boolean): Promise<any>;
        /**
         * 更新组的优先级顺序
         * @param list 存储数据的队列
         * @param priority 优先级
...
declare module RES {
     ...
     * @language zh_CN
     */
    function loadGroup(name: string, priority?: number, reporter?: PromiseTaskReporter, isTmpLoad?: boolean): Promise<void>;
    /**
    ...
    class Resource extends egret.EventDispatcher {
         ...
         */
        loadGroup(name: string, priority?: number, reporter?: PromiseTaskReporter, isTmpLoad?: boolean): Promise<any>;
        private _loadGroup(name, priority?, reporter?, isTmpLoad?);
        /**
         * 创建自定义的加载资源组,注意：此方法仅在资源配置文件加载完成后执行才有效。
         * 可以监听ResourceEvent.CONFIG_COMPLETE事件来确认配置加载完成。
         * @method RES.ResourceConfig#createGroup
...
declare module RES.processor {
    interface Processor {
        ...
        onTempLoadDone?(host: ProcessHost, response: any, resource: ResourceInfo): void;
    }
