...
declare module fairygui {
    class GComponent extends GObject {
        ...
        applyController(c: Controller, runAction?: boolean): void;
...
declare module fairygui {
    class GTextField extends GObject {
        ...
        textParser: Function;
        /**
         * (obj) => egret.ITextElement[]
         */
        funcParser: Function;
        static textLocaler: (id: number) => string;
        static wordWrap: boolean;
        protected _appendChildren: Array<GObject>;
        constructor();
        protected createDisplayObject(): void;
        private switchBitmapMode(val);
        addAppendChild(obj: GObject): void;
        dispose(): void;
        text: string;
...
declare module fairygui {
    class Controller extends egret.EventDispatcher {
        ...
        setSelectedIndex(value?: number, runAction?: boolean): void;
...
declare module fairygui {
    class GList extends GComponent {
        ...
        */
        ...
        lineCount: number;
        cacheContent(flag: boolean): void;
        columnCount: number;
        lineGap: number;
        columnGap: number;
        align: AlignType;
        ...
        removeChildAt(index: number, dispose?: boolean): GObject;
        removeChild(child: fairygui.GObject, dispose?: boolean): GObject;
...
declare module fairygui {
    class GRoot extends GComponent {
        ...
        playSoundAsync(name: string, volumeScale?: number): void;
...
declare module fairygui {
    class ScrollPane extends egret.EventDispatcher {
        ...
        constructor(owner: GComponent);
        setup(buffer: ByteBuffer): void;
        cacheAsBitmap(flag: boolean): void;
        dispose(): void;
...
declare module fairygui {
    class UIPackage {
        ...
        static preloadResourceByName(pkgName: string, name: string): Promise<any[]>;
        static preloadResource(pi: PackageItem): Promise<any[]>;
