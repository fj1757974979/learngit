...
pMainTest = pMainTest or class(menuMain)

pMainTest.init = function(self)
	menuMain.init(self)
end

pMainTest.isHideInviteWnd = function(self)
	return true
end

pMainTest.getBottomParent = function(self)
...
pMainTest.adjustUI = function(self)
...
pMainTest.regEvent = function(self)
...
pMainTest.showGroundEnter = function ( self )
    --平和麻将关闭暂不显示俱乐部图标
	self.btn_group:show(false)
end
